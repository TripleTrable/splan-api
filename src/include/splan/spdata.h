...
extern server_user_config
    _server_config; /*!< Global struct to pass the configuration into the context of the callback handler from microhttpd*/
...
typedef struct {
    ...
    char *startdate;
    /*!< startdata of the semester JSON object */ // potential change to sruct tm
    char *enddate;
    /*!< enddate of the semester JSON object */ // potential change to sruct tm
